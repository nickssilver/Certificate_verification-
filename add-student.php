...
<html> 
	<head> 
		...
		<title> Certificate Verfication Sys </title>
	...
	<body> 
			...
			<nav class="navbar navbar-default navbar-fixed-top">
			  <div class="container">
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="http://www.pronic.co.ke"> <strong>certificate verification sys</strong> </a>
				</div>
		...
		<footer class="footer">
			<div class="container">
				<p> &copy;Copyrights:<?php echo date("Y"); ?> <br />All Rights Reserved By <span> <a href="http://www.pronic.co.ke"> <strong> <i>CV Sys</i> </strong> </a> </span> </p>
			</div>
		</footer>
